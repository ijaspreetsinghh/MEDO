    ...
    <div class="container register">
                    <div class="row">
                        ...
                        <div class="col-md-3 register-left">
                            ...
                            <h3 class="well">Register Now !!</h3>
                            <p>Welcome, <br>You are 30 seconds away from being the partner of the world's best fitness organization.</p>
                            <a href="login.php"><input type="submit" name="login" value="Login Here"/><br/></a>
                        </div>
                              ...
                              <h3 class="register-heading">Register as a Civilian</h3>
                                    <div class="row register-form">
                                     ...
                                     <form action="registercheck.php" method="post" name="myform" onsubmit="return myf()" enctype="multipart/form-data">
                                                ...
                                                <input type="text" class="form-control" placeholder="First Name *" name="first_name" id="first" value="" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Username *" name="user" id="user" value="" />
                                            </div>
                                            <div class="form-group">
                                                <input type="password" class="form-control" name="password" placeholder="Password *" id="pass1" value="" />
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Last Name *" name="last_name" id="last" value="" />
                                            </div>
                                            <div class="form-group">
                                                <input type="email" minlength="10" maxlength="30" name="email" id="email" class="form-control" placeholder="Your Email *" value="" />
                                            </div>
                                            <div class="form-group">
                                              <input type="password" class="form-control" name="password"  placeholder="Confirm Password *" id="pass2" value="" />
                                            </div>
                                            <div class="form-group">
                                                <input type="file" class="form-control" name="image" id="image" placeholder="Your Profile Picture *" value="" />
                                            </div>
                                              <input type="hidden" name="user_type" value="Doctor" id="x">
                                              <input type="submit" class="btnRegister" name="reg" value="submit"/>
                                            </form>
                                        </div>
                                    </div>
                                </div>
